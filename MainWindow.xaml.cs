...
namespace ReggApp
{
    ...
    {
        private string LogFile = @"F:\logi.txt";
        private List<string> existingLogins = new List<string> { "admin", "user1", "user2" };
        ...
        private bool ValidateRegistration(string login, string password, string confirmPassword, out string message)
        {
        ...
        private void LogSuccessfulRegistration(string login, string password)
        {
        ...
        private void LogFailedRegistration(string login, string password, string errorMessage)
        {
